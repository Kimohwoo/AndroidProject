package com.android.andriodproject
    ...
    import com.android.andriodproject.retrofit2.LikeRetrofitService
...
class BoardActivity : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
...
//        private val binding get() = _binding!!
        ...
        lateinit var retrofitService: BoardService
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val feedListView = binding.feedList
...
//                findNavController().navigate(R.id.action_postFragment_to_postLikeFragment)
            ...
            val retrofit = Retrofit.Builder()
                ...
                .build()
            retrofitService = retrofit.create(BoardService::class.java)
